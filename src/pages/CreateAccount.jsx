...
const CreateAccount = () => {
  ...
  return (
    <>
          ...
          <div className="flex md:flex-row flex-col bg-white rounded-2xl">
            ...
            <div className="py-10 sm:ps-10 md:pe-5 px-5 md:w-[70%] flex flex-col items-center justify-center rounded-2xl">
              <div className="flex flex-col w-full">
                ...
                {wrongGst && (
                  <p className="text-red-500 text-sm mt-1">The GST number is incorrect.</p>
                )}
                ...
                {/* /* Email input (replace your existing email input) */}
                <div className="relative mt-8">
                  <input
                    type="email"
                    name="email"
                    ...
                    className={`w-full py-3 outline-none px-2 border ${emailError ? "border-red-500" : formData.email && !emailError ? "border-green-500" : "border-[#0A122A]/[.5]"
                      } rounded-md`}
                  />
                ...
                {/* Confirm Email input (replace your existing confirmEmail input) */}
                <div className="relative mt-4">
                  <input
                    ...
                    onPaste={(e) => {
                      e.preventDefault();
                      toast.error("Please type the confirmation email — paste is disabled.", { position: toast.POSITION.BOTTOM_RIGHT, autoClose: 2000 });
                    }}
                    onDrop={(e) => {
                      e.preventDefault();
                      toast.error("Drop disabled. Type the confirmation email manually.", { position: toast.POSITION.BOTTOM_RIGHT, autoClose: 2000 });
                    }}
                    onCopy={(e) => e.preventDefault()}
                    onCut={(e) => e.preventDefault()}
                    onContextMenu={(e) => e.preventDefault()}
                    className={`w-full py-3 outline-none px-2 border ${confirmEmailError ? "border-red-500" : formData.confirmEmail && !confirmEmailError ? "border-green-500" : "border-[#0A122A]/[.5]"
                      } rounded-md`}
                  />
                ...
                <div className="flex md:flex-row flex-col gap-4 w-full">
                  <div className="mt-8 flex-1">
                    ...
                    >
                      <option value="">Select State</option>
                      {states && states.map((state, index) => <option key={index} value={state.name}>{state.name}</option>)}
                    </select>
                  </div>
                  ...
                  <div className="mt-8 flex-1">
                    ...
                    >
                      <option value="">Select City</option>
                      {cities && cities.map((city, index) => <option key={index} value={city.name}>{city.name}</option>)}
                    </select>
                  </div>
                </div>
                ...
                <div className="relative mt-8">
                  <input
                    ...
                    type={showPassword ? "text" : "password"}
                    placeholder="Password"
                    className={`outline-none py-3 px-2 border ${passwordError
                      ? "border-red-500"
                  ...
                  />
                  <FontAwesomeIcon icon={showPassword ? faEyeSlash : faEye} className="absolute top-[30%] right-[2%] cursor-pointer" onClick={togglePasswordVisibility} />
                </div>
                ...
                {formData.password && (
                  <div className="mt-2 text-sm">
                    <p className={`flex items-center ${passwordCriteria.length ? "text-green-500" : "text-red-500"}`}>
                      <FontAwesomeIcon icon={passwordCriteria.length ? faCheck : faXmark} className="mr-1" />
                      At least 8 characters
                    </p>
                    <p className={`flex items-center ${passwordCriteria.uppercase ? "text-green-500" : "text-red-500"}`}>
                      <FontAwesomeIcon icon={passwordCriteria.uppercase ? faCheck : faXmark} className="mr-1" />
                      At least one uppercase letter
                    </p>
                    <p className={`flex items-center ${passwordCriteria.lowercase ? "text-green-500" : "text-red-500"}`}>
                      <FontAwesomeIcon icon={passwordCriteria.lowercase ? faCheck : faXmark} className="mr-1" />
                      At least one lowercase letter
                    </p>
                    <p className={`flex items-center ${passwordCriteria.number ? "text-green-500" : "text-red-500"}`}>
                      <FontAwesomeIcon icon={passwordCriteria.number ? faCheck : faXmark} className="mr-1" />
                      At least one number
                    </p>
                    <p className={`flex items-center ${passwordCriteria.special ? "text-green-500" : "text-red-500"}`}>
                      <FontAwesomeIcon icon={passwordCriteria.special ? faCheck : faXmark} className="mr-1" />
                      At least one special character
                    </p>
                  </div>
                )}
                ...
                <div className="relative mt-8">
                  <input
                    ...
                    type={showPassword1 ? "text" : "password"}
                    placeholder="Confirm Password"
                    className={`outline-none py-3 px-2 border ${confirmPasswordError
                      ? "border-red-500"
                      : formData.confirmPassword && !confirmPasswordError
                        ? "border-green-500"
                        : "border-[#0A122A]/[.5]"
                  ...
                  />
                  <FontAwesomeIcon icon={showPassword1 ? faEyeSlash : faEye} className="absolute top-[30%] right-[2%] cursor-pointer" onClick={togglePasswordVisibility1} />
                </div>

                {confirmPasswordError && <p className="text-red-500 text-sm mt-1">{confirmPasswordError}</p>}
                {formData.confirmPassword && !confirmPasswordError && <p className="text-green-500 text-sm mt-1">Passwords match</p>}
                ...
                <div className="flex items-center justify-center">
                  {loading ? (
                    <button className="bg-darkBlue text-lg mt-8 text-white w-[140px] h-[40px] rounded-md font-medium">
                      <img src={loaderImage} alt="" className="img-fluid animate-spin h-[25px] mx-auto" />
                    </button>
                  ) : (
                    <button className="bg-darkBlue text-lg mt-8 text-white w-[140px] h-[40px] rounded-md font-medium" onClick={handleRegister}>
                      Register
                    </button>
                  )}
                </div>
            ...
            <div className="md:w-[30%] h-[1150px]  md:flex hidden flex-col justify-center items-center registration-image rounded-2xl relative">
              <div className=" flex flex-col mt-[500px] px-[10px] items-center absolute h-full w-full z-[1111]">
                ...
                <Link to="/login">
                  <button className="bg-[white] text-black  px-6 py-3 mt-4 border border-[white]/[.5] rounded-md">Login</button>
                </Link>
              </div>
              <div className="absolute top-0 left-0 h-full w-full opacity-[0.3] bg-black z-1 rounded-2xl">
                <div className=""></div>
              ...
              <div className="absolute top-[0px]">
                <div className="flex justify-center">
                  <img src={headerImage} alt="" className="w-full rounded-tr-xl" />
                </div>
              </div>
            </div>
          </div>
      ...
      {gstLoader && (
        <div className=" fixed  inset-0 flex items-center justify-center bg-white bg-opacity-50 z-50">
          <img src="https://chembizzstorage.blob.core.windows.net/chembizz-files/loader1.gif" alt="Loading..." className="w-20 h-20" />
        </div>
      )}
    </>
  );
