...
const GenerateAutomaticInvoice = () => {
    ...
    const inquiryDetail = async () => {
        ...
        if (data.success) {
            ...
            // console.log(allData)
            const poData = data?.data?.[0]?.po_data?.[0]
            setInquiryType(allData?.inq_type)
            const buyerCompany = allData?.buyer_company;
            const sellerCompany = allData?.seller_company;
            setBuyerCompanyId(buyerCompany?._id)

            const selectedStates = countries.find((e) => e.name === poData?.bill_to_country);
            setStates(selectedStates?.states || []);

            if (selectedStates) {
                const selectedCities = selectedStates.states.find((e) => e.name === poData?.bill_to_state);
                setCities(selectedCities?.cities || []);
            }


            const selectedStatesForShipped = countries.find((e) => e.name === poData?.shipped_to_country);
            setShippedStates(selectedStatesForShipped?.states || []);

            if (selectedStatesForShipped) {
                const selectedCities = selectedStatesForShipped.states.find((e) => e.name === poData?.shipped_to_state);
            ...
            setFormData(prevFormData => ({
                ...prevFormData,
                bill_to_gst_in: poData?.bill_to_gst_in,
                bill_to_name: poData.bill_to_name,
                bill_to_address: poData.bill_to_address,
                bill_to_country: poData.bill_to_country,
                bill_to_state: poData.bill_to_state,
                bill_to_city: poData.bill_to_city,
                bill_to_pincode: poData.bill_to_pincode,
                bill_to_phone: poData.bill_to_phone,
                shipped_to_gst_in: poData?.shipped_to_gst_in,
                shipped_to_name: poData.shipped_to_name,
                shipped_to_address: poData.shipped_to_address,
                shipped_to_country: poData.shipped_to_country,
                shipped_to_state: poData.shipped_to_state,
                shipped_to_city: poData.shipped_to_city,
                shipped_to_pincode: poData.shipped_to_pincode,
                shipped_to_phone: poData.shipped_to_phone,
    ...
    useEffect(() => {
        if (formData?.payment_terms !== "") {
            handlePaymentTermsChange(formData?.payment_terms)
        }
    ...
    const generatePo = async () => {
        ...
        if (formData?.upload_COA === null) {
            toast.error('Please Select COA Document', {
    ...
    useEffect(() => {
        if (banks?.length > 0) {
            const selectedBank = banks && banks?.find(bank => bank?.priority === "primary");
    ...
    const checkStates = () => {
        const { bill_to_state, shipped_to_state } = formData;

        if (bill_to_state === shipped_to_state) {
            setNewVariable("same");
        } else {
    ...
    useEffect(() => {
        checkStates();
    }, [formData.bill_to_state, formData.shipped_to_state]);
                            ...
                            <tr className='border-[3px] border-blue-400 border-b-0'>
                                <th className='border-blue-400 border-r-[3px] w-1/3 font-medium text-2xl py-3'>
                                    <div className='flex justify-center items-center gap-4'>
                                        <span className='font-semibold'>GSTIN : </span> <input type="text" className='border-2 border-gray-300 px-2 text-xl py-1 rounded-md w-[220px]' onChange={handleChange} maxLength={15} name='bill_to_gst_in' value={formData?.bill_to_gst_in}
                                            onInput={(e) => {
                            ...
                            <tr className=''>
                                <td className='border-blue-400 border-r-[3px] font-medium ps-5 pe-4'>
                                    <div className="grid grid-cols-[1fr,3fr,] items-center pb-2">
                                        <p className=''>Name</p>
                                        <p className='flex items-center gap-2'>:
                                            <input disabled type='text' name='bill_to_name' value={formData?.bill_to_name} onChange={handleChange} className='w-full border-2 border-gray-300 px-2 py-1 rounded-md' />
                                        </p>
                                    </div>
                                </td>
                                <td className='border-blue-400 border-r-[3px] font-medium ps-5 pe-4 pb-2 '>
                                    <div className="grid grid-cols-[1fr,3fr,] items-center">
                                        <p className=''>Name</p>
                                        <p className='flex items-center gap-2'>:
                                            <input disabled type='text' name='shipped_to_name' value={formData?.shipped_to_name} onChange={handleChange} className='w-full border-2 border-gray-300 px-2 py-1 rounded-md' /></p>
                                    </div>
                                </td>
                                <td className='border-blue-400 border-r-[3px] font-medium ps-5 pe-4 pb-2'>
                                    <div className="grid grid-cols-[2fr,3fr,] items-center">
                                ...
                                <td className='border-blue-400 border-r-[3px] font-medium ps-5 pe-1 pb-2'>
                                    <div className="grid grid-cols-[1fr,3fr,] items-center ">
                                        ...
                                        <p className='flex items-center gap-2 me-3'>:
                                            <textarea disabled onChange={handleChange} name='bill_to_address' value={formData?.bill_to_address} className='w-full border-2 border-gray-300 px-2 py-1 rounded-md' /></p>
                                    </div>
                                </td>
                                <td className='border-blue-400 border-r-[3px] font-medium ps-5 pe-1 pb-2'>
                                    <div className="grid grid-cols-[1fr,3fr,] items-center">
                                        <p className=''>Address</p>
                                        <p className='flex items-center gap-2 me-3'>:
                                            <textarea disabled onChange={handleChange} name='shipped_to_address' value={formData?.shipped_to_address} className='w-full border-2 border-gray-300 px-2 py-1 rounded-md' /></p>
                                    </div>
                                </td>
                                <td className='border-blue-400 border-r-[3px] font-medium ps-5 pe-4 pb-2'>
                            ...
                            <tr className=''>
                                <td className='border-blue-400 border-r-[3px] font-medium ps-5 pe-4 pb-2 '>
                                    <div className="grid grid-cols-[1fr,3fr,] items-center">
                                        ...
                                        <p className='flex items-center gap-2'>:
                                            <select disabled name='bill_to_country' value={formData?.bill_to_country} onChange={handleChange} className='w-full border-2 border-gray-300 w-[70%] px-2 py-1 rounded-md'>
                                                <option value="">select</option>
                                ...
                                <td className='border-blue-400 border-r-[3px] font-medium ps-5 pe-4 pb-2 '>
                                    <div className="grid grid-cols-[1fr,3fr,] items-center">
                                        <p className=''>Country</p>
                                        <p className='flex items-center gap-2'>:
                                            <select disabled name='shipped_to_country' value={formData?.shipped_to_country} onChange={handleChange} className='w-full border-2 border-gray-300 w-[70%] px-2 py-1 rounded-md'>
                                                <option value="">select</option>
                                                {countries && countries.map((e) => (
                                                    <option value={e.name}>{e.name}</option>
                                                ))}
                            ...
                            <tr className=''>
                                <td className='border-blue-400 border-r-[3px] font-medium ps-5 pe-4 pb-2 '>
                                    <div className="grid grid-cols-[1fr,3fr,] items-center">
                                        <p className=''>State</p>
                                        <p className='flex items-center gap-2'>:
                                            <select disabled name='bill_to_state' onChange={handleChange} value={formData?.bill_to_state} className='w-full border-2 border-gray-300 w-[70%] px-2 py-1 rounded-md'>
                                                <option value="">select</option>
                                                {states && states.map((e) => (
                                                    <option value={e.name}>{e.name}</option>
                                                ))}
                                ...
                                <td className='border-blue-400 border-r-[3px] font-medium ps-5 pe-4 pb-2 '>
                                    <div className="grid grid-cols-[1fr,3fr,] items-center">
                                        <p className=''>State</p>
                                        <p className='flex items-center gap-2'>:
                                            <select disabled name='shipped_to_state' value={formData?.shipped_to_state} onChange={handleChange} className='w-full border-2 border-gray-300 w-[70%] px-2 py-1 rounded-md'>
                                                <option value="">select</option>
                            ...
                            <tr className=''>
                                <td className='border-blue-400 border-r-[3px] font-medium ps-5 pe-4 pb-2 '>
                                    <div className="grid grid-cols-[1fr,3fr,] items-center">
                                        <p className=''>City</p>
                                        <p className='flex items-center gap-2'>:
                                            <select disabled name='bill_to_city' value={formData?.bill_to_city} onChange={handleChange} className='w-full border-2 border-gray-300 w-[70%] px-2 py-1 rounded-md'>
                                                <option value="">select</option>
                                                {cities && cities.map((e) => (
                                                    <option value={e.name}>{e.name}</option>
                                                ))}
                                ...
                                <td className='border-blue-400 border-r-[3px] font-medium ps-5 pe-4 pb-2 '>
                                    <div className="grid grid-cols-[1fr,3fr,] items-center">
                                        <p className=''>City</p>
                                        <p className='flex items-center gap-2'>:
                                            <select disabled name='shipped_to_city' value={formData?.shipped_to_city} onChange={handleChange} className='w-full border-2 border-gray-300 w-[70%] px-2 py-1 rounded-md'>
                                                <option value="">select</option>
                                ...
                                {/* {inquiryType === "commercial" && (
                                    <td className='border-blue-400 border-r-[3px] font-medium ps-5 pe-4 py-6'>
                                        <div className="grid grid-cols-[2fr,3fr,] items-center">
                                            ...
                                            <p className='flex items-center gap-2'>:
                                                <select value={formData.delivery_time} onChange={handleChange} name='delivery_time' className='w-full border-2 border-gray-300 px-2 py-1 rounded-md' id="">
                                                    <option value="">select</option>
                                                    <option value="Immediate">Immediate</option>
                                    ...
                                    <>
                                        <div className='flex justify-between border-blue-400 border-b-[3px] py-1 px-2'>
                                            ...
                                            <p className='font-semibold flex items-center'>
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 3h12M6 8h12M6 13l8.5 8M6 13h3m0 0c6.667 0 6.667-10 0-10"></path></svg>{(totals.totalGstAmount).toFixed(2)}</p>
                                        </div>
                                    </>
                                )}
                                <div className='flex justify-between bg-blue-100 border-blue-400 border-b-[3px] py-1 px-2'>
                                        ...
                                        <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-md py-4">
                                            <div className="bg-white">
                                                ...
                                                <div className='bg-gray-50 px-7 pt-5 pb-6'>
                                                    {banks.length === 0 ? (
                                                        <p>Please <span className='text-blue-500 underline cursor-pointer' onClick={handleNavigateAddBank}>Insert</span> Bank Details</p>
                                                    ) : (
                                                                ...
                                                                <div key={e.account_number} className='flex gap-3'>
                                                                    <div>
                                                                        <input
                                                                            type="radio"
                                                                            name="bank"
                                                                            checked={e?.account_number === selectedBankAccountNumber}
...
export default GenerateAutomaticInvoice
