...
const EditPo = () => {
    ...
    const fetchFinalDetails = async (e) => {
        ...
        const selectedStates = countries.find((e) => e.name === allData?.bill_to_country);
        setStates(selectedStates?.states || []);

        if (selectedStates) {
            const selectedCities = selectedStates.states.find((e) => e.name === allData?.bill_to_state);
            setCities(selectedCities?.cities || []);
        }

        const selectedStatesForShipped = countries.find((e) => e.name === allData?.shipped_to_country);
        setShippedStates(selectedStatesForShipped?.states || []);

        if (selectedStatesForShipped) {
            const selectedCities = selectedStatesForShipped.states.find((e) => e.name === allData?.shipped_to_state);
        ...
        setFormData(prevFormData => ({
            ...
            shipped_to_pincode: allData?.pincode,
    ...
    const fetchCatelogData = async () => {
        const token = `Bearer ${localStorage.getItem("chemicalToken")}`;
        const res = await fetch(`${BASE_URL}api/product/displayAllProductsByCompany`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
                Authorization: token,
    ...
    const handleProductEdit = (e) => {
        ...
        setSearchInputValue(e?.chem_name)
        setProductCas(e?.cas_no);
        setProductName(e?.chem_name);
        setProductFormula(e?.mol_formula);
        setHsn(e?.hsn);
        setQuantity(e?.qty);
            ...
            <div className='h-[100vh] max-w-[80vw] pt-2'>
                ...
                <div className='bg-white pe-5 pb-10'>
                    <div className='mb-10 flex justify-between'>
                        ...
                        <button onClick={handleYesNo} className='bg-darkBlue text-white text-xs px-20 rounded-[10px]'>Submit</button>
                    </div>
                    ...
                    <div>
                        ...
                        <table className="w-full border-[3px] border-blue-400 border-b-0 table-auto " onClick={() => setShowCatalogs(false)}>
                                ...
                                <tr className='border-[3px] border-blue-400 border-b-0'>
                                    <th className='border-blue-400 border-r-[3px] w-1/3 font-medium text-2xl py-3'>
                                        <div className='flex justify-center items-center gap-4'>
                                            <span className='font-semibold'>GSTIN : </span> <input type="text" className='border-2 border-gray-300 px-2 text-xl py-1 rounded-md w-[220px]' maxLength={15} onChange={handleChange} name='bill_to_gst_in' value={formData?.bill_to_gst_in}
                                                onInput={(e) => {
                            ...
                            <tbody className='border-[3px] border-blue-400'>
                                <tr className=''>
                                    <td className='border-blue-400 border-r-[3px] border-t-[3px] border-blue-400 font-medium ps-5 pt-5 pb-3'>Details of Buyer : </td>
                                    <td className='border-blue-400 border-r-[3px] border-t-[3px] border-blue-400 font-medium ps-5 py-2'>Seller Detail | Shipped to  :
                                        <span className='text-[10px] text-blue-800 ms-2 me-2'>
                                            {/* <input
                                                type="checkbox"
                                                className='h-[8px]'
                                            ...
                                            />{' '}
                                            Same as Bill to */}
                                            <span className='bg-blue-700 text-white px-1 leading-[20px]' onClick={() => setSelectAddress(true)}>+</span>
                                        </span>
                                    </td>
                                    ...
                                    <td className='border-blue-400 border-r-[3px] font-medium ps-5 pe-4'>
                                        <div className="grid grid-cols-[1fr,3fr,] items-center pb-2">
                                            ...
                                            <p className='flex items-center gap-2 leading-[40px]'>:
                                                ...
                                                <input onChange={handleChange} name='bill_to_name' type="text" value={formData?.bill_to_name} className='w-full border border-gray-300 px-2 rounded-md' /></p>
                                        </div>
                                    </td>
                                    ...
                                    <td className='border-blue-400 border-r-[3px] font-medium ps-5 pb-2 pe-2'>
                                        <div className="grid grid-cols-[1fr,3fr,] items-center">
                                            ...
                                            <p className='flex items-center gap-2 me-3'>:
                                                {/* <span className='bg-blue-700 text-white px-1 '>+</span> */}
                                                <textarea onChange={handleChange} name='bill_to_address' value={formData?.bill_to_address} className='border-2 border-gray-300 px-2 py-1 rounded-md w-full'></textarea></p>
                                        </div>
                                    </td>
                                    <td className='border-blue-400 border-r-[3px] font-medium ps-5 pb-2 pe-2'>
                                        <div className="grid grid-cols-[1fr,3fr,] items-center">
                                            <p className=''>Address</p>
                                            <p className='flex items-center gap-2 me-3'>: <span className='bg-blue-700 text-white px-1 '>+</span>
                                ...
                                <tr className=''>
                                    ...
                                    <td className='border-blue-400 border-r-[3px] font-medium ps-5 pb-2 pe-4'>
                                        <div className="grid grid-cols-[1fr,3fr,] items-center">
                                            <p className=''>Country</p>
                                            <p className='flex items-center gap-2'>: <span className='bg-blue-700 text-white px-1 '>+</span>
                                ...
                                <tr className=''>
                                    <td className='border-blue-400 border-r-[3px] font-medium ps-5 pb-2 pe-4'>
                                        <div className="grid grid-cols-[1fr,3fr,] items-center">
                                            ...
                                            <p className='flex items-center gap-2'>:
                                                {/* <span className='bg-blue-700 text-white px-1 '>+</span> */}
                                                <select name='bill_to_state' value={formData.bill_to_state} onChange={handleChange} className='border-2 border-gray-300 w-full px-2 py-1 rounded-md'>
                                                    <option value="">select</option>
                                                    {states && states.map((e) => (
                                                        <option value={e.name}>{e.name}</option>
                                                    ))}
                                ...
                                <tr className=''>
                                    <td className='border-blue-400 border-r-[3px] font-medium ps-5 pb-2 pe-4'>
                                        <div className="grid grid-cols-[1fr,3fr,] items-center">
                                            ...
                                            <p className='flex items-center gap-2'>:
                                                {/* <span className='bg-blue-700 text-white px-1 '>+</span> */}
                                                <select name='bill_to_city' value={formData?.bill_to_city} onChange={handleChange} className='border-2 border-gray-300 w-full px-2 py-1 rounded-md'>
                                                    <option value="">select</option>
                                                    {cities && cities.map((e) => (
                                                        <option value={e.name}>{e.name}</option>
                                                    ))}
                                ...
                                <div className='grid grid-cols-[3fr,1fr,1.4fr,1fr,1.2fr,2fr,1fr]'>
                                    ...
                                    <div className='py-3 px-3 border-blue-400 border-r-[3px]'>
                                        <select value={gst} onChange={(e) => setGst(e.target.value)} name="" id="" className='border-2 border-gray-400 py-2 outline-none rounded-md text-gray-500 text-xs  ps-3 w-full '>
                                            <option value="">IGST Amount(%)</option>
                                    ...
                                    <div className='py-3 px-3'>
                                        <button className='w-full py-1 outline-none rounded-md text-white bg-blue-400' onClick={handleProductAdd}>Submit</button>
                                    </div>
                                </div>
                            </div>
                        )}
                        ...
                        <table className="w-full border-[3px] border-blue-400 table-auto mt-6 mb-8" onClick={() => setShowCatalogs(false)}>
                            <thead className='border-[3px] border-blue-400 bg-blue-100'>
                                ...
                                <tr className='border-[3px] border-blue-400'>
                                    ...
                                    <th className='w-[5%] font-semibold text-lg border-blue-400 border-r-[3px]'>Edit</th>
                                </tr>
                            ...
                            <div className='grid grid-cols-[1.8fr,1.2fr,]'>
                                ...
                                <div className='border-blue-400 border-b-0 border-[3px]'>
                                    ...
                                    <div className='flex justify-between bg-blue-100 border-blue-400 border-b-[3px] py-1 px-2'>
                                        ...
                                        <p className='font-semibold flex items-center'><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 3h12M6 8h12M6 13l8.5 8M6 13h3m0 0c6.667 0 6.667-10 0-10"></path></svg>{totalTaxAmount} ({totalTaxInPercentage}%)</p>
                                    </div>
                                    <div className='flex justify-between bg-blue-100 border-blue-400 border-b-[3px] py-1 px-2'>
                            ...
                            <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl max-w-md py-4">
                                <div className="bg-white py-3 w-[400px]">
                                    <div className="flex flex-col items-center">
                                        ...
                                        <h3 className='font-semibold text-xl mt-4 text-center'>Are You Sure You Want To Edit PO?</h3>
                                    </div>
                                </div>
