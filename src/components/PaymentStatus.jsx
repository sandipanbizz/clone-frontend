      ...
      <div className="bg-white shadow-md rounded-xl p-8 max-w-md w-full text-center">
          ...
          <>
            ...
            {merchantTransactionId && (
              <div className="bg-gray-50 p-3 rounded-lg mb-6">
                ...
                <p className="text-sm font-medium text-gray-800">{merchantTransactionId}</p>
              </div>
            )}
          </>
        ) : (
        ...
        {!isSuccess && (
          <button
            ...
            className="mt-3 bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-2 px-6 rounded-lg transition-all w-full"
          >
            Try Again
          </button>
        )}
